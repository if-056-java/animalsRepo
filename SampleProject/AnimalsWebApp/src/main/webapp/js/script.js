...
function getAllPets() {
	document.getElementById("getAll").onclick = function() {
		...
		myRequest.open('GET', 'http://localhost:8080/AnimalsWebApp/webapi/pets/', true);
		myRequest.send(null);
...
function getPet() {
	document.getElementById("getPet").onclick = function() {
		...
		console.log(petId);
		myRequest.open('GET', 'http://localhost:8080/AnimalsWebApp/webapi/pets/'+petId, true);
		myRequest.send(null);
	}
}
...
function getPetOw() {
	document.getElementById("getPetOw").onclick = function() {
		...
		console.log(petId);
		myRequest.open('GET', 'http://localhost:8080/AnimalsWebApp/webapi/pets/'+petId + '/owner', true);
		myRequest.send(null);
	}
}
...
function postPet() {
	document.getElementById("postPet").onclick = function() {
		...
		myRequest.open('POST', 'http://localhost:8080/AnimalsWebApp/webapi/pets/pet', true);
...
function delPet() {
	document.getElementById("delPet").onclick = function() {
		...
		console.log(petId);
		myRequest.open('DELETE', 'http://localhost:8080/AnimalsWebApp/webapi/pets/'+petId, true);
		myRequest.send(null);
	}
}
...
function updatePet() {
	document.getElementById("updPet").onclick = function() {
		...
		myRequest.open('PUT', 'http://localhost:8080/AnimalsWebApp/webapi/pets/pet', true);
		myRequest.setRequestHeader("Content-type","application/x-www-form-urlencoded");
