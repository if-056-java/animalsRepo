...
//	private final static String FILEPATH = "C:/dev/STSworkspace/rest2/data.ser" ; //alternative route
	private final static String FILEPATH = "C:\\dev\\STSworkspace\\rest2\\data.ser" ;
	...
	public void loadDataFromFile() {
		...
		(	ObjectInputStream ois = new ObjectInputStream(new FileInputStream("C:\\dev\\STSworkspace\\rest2\\rest2\\data.ser"));	) 
		{	
