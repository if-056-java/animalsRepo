...
public class GoogleScribeExample {
    ...
    public static void main(String[] args)
    {
        ...
        String apiKey = "601704593845-8nbsaqf58sk03plpd6cqd5snskc2v6du.apps.googleusercontent.com";
        String apiSecret = "1OwF1fo-F-Ky5SeBlmNLibhx";
        String callbackUrl = "http://localhost:8080/oauth/webapi/login/google_token";
