angular.module('AnimalsDetailedEditor', ['angular-bootstrap-select', 'angular-bootstrap-select.extra', 'ui.bootstrap', 'AnimalsListService'])
    .controller('AnimalsDetailedEditorController', ['$scope', 'AnimalsListService', '$routeParams', '$window', '$filter', function($scope, AnimalsListService, $routeParams, $window, $filter) {
